...
export function Apple(props: ArtProps) {
  return (
    <Art {...props}>
      <path
        d="M50 26 q3 -12 14 -14 q1 11 -10 15 Z"
        fill="#5FAF4E"
        stroke={OUTLINE}
        strokeWidth={2.4}
...
export function Orange(props: ArtProps) {
  return (
    <Art {...props}>
      <path
        d="M52 22 q10 -12 22 -10 q-2 12 -18 14 Z"
        fill="#5FAF4E"
        stroke={OUTLINE}
        strokeWidth={2.4}
        strokeLinejoin="round"
...
export function Broccoli(props: ArtProps) {
  return (
    <Art {...props}>
      <path
        d="M40 58 q10 -6 20 0 q2 22 -2 30 q-8 4 -16 0 q-4 -8 -2 -30 Z"
        fill="#A8D08D"
        stroke={OUTLINE}
        strokeWidth={3}
        strokeLinejoin="round"
...
export function Grapes(props: ArtProps) {
  ...
  return (
    <Art {...props}>
      ...
      />
      <path
        d="M46 16 q10 -8 18 -2 q-10 6 -18 2 Z"
        fill="#5FAF4E"
        stroke={OUTLINE}
        strokeWidth={2.2}
        strokeLinejoin="round"
