...
export function Duck(props: ArtProps) {
  return (
    <Art {...props}>
      ...
      />
      <path
        d="M70 62 q14 6 6 18 q-10 6 -18 -2 Z"
        fill="#FFC61A"
        stroke={OUTLINE}
        strokeWidth={2.5}
        strokeLinejoin="round"
      ...
      />
      <path
        d="M22 34 q-14 3 -14 8 q0 5 14 6 Z"
        fill="#F79420"
        stroke={OUTLINE}
        strokeWidth={2.5}
        strokeLinejoin="round"
...
export function Cat(props: ArtProps) {
  return (
    <Art {...props}>
      ...
      />
      <path
        d="M50 67 q-5 6 -10 1 M50 67 q5 6 10 1"
        stroke={OUTLINE}
        strokeWidth={2.4}
        fill="none"
        strokeLinecap="round"
...
export function Dog(props: ArtProps) {
  return (
    <Art {...props}>
      ...
      />
      <path
        d="M50 68 q-6 6 -11 0 M50 68 q6 6 11 0"
        stroke={OUTLINE}
        strokeWidth={2.4}
        fill="none"
        strokeLinecap="round"
...
export function Horse(props: ArtProps) {
  return (
    <Art {...props}>
      ...
      />
      <path
        d="M28 30 q-2 -18 22 -18 q24 0 22 18 q-8 -8 -22 -8 q-14 0 -22 8 Z"
        fill="#5C4128"
        stroke={OUTLINE}
        strokeWidth={2.4}
        strokeLinejoin="round"
...
export function Chicken(props: ArtProps) {
  return (
    <Art {...props}>
      <path
        d="M38 32 q2 -13 8 -6 q4 -11 9 -2 q6 -7 7 7 Z"
        fill="#E4574C"
        stroke={OUTLINE}
        strokeWidth={2.5}
        strokeLinejoin="round"
      ...
      />
      <path
        d="M72 52 q12 10 2 22 q-9 4 -13 -5 Z"
        fill="#F1E7D6"
        stroke={OUTLINE}
        strokeWidth={2.4}
        strokeLinejoin="round"
      />
      <Eyes x1={41} x2={59} y={50} r={6.5} pupil={3.2} />
      <path
        d="M43 62 L57 62 L50 71 Z"
        fill="#F79420"
        stroke={OUTLINE}
        strokeWidth={2.2}
        strokeLinejoin="round"
