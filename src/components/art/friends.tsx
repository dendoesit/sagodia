...
export function Pip({ waving = false, ...props }: ArtProps & { waving?: boolean }) {
  return (
    <Art {...props}>
      <ellipse cx={50} cy={78} rx={26} ry={20} fill="#F79E52" stroke={OUTLINE} strokeWidth={3} />
      ...
      <path d="M22 30 L18 6 L42 20 Z" fill="#F79E52" stroke={OUTLINE} strokeWidth={2.8} strokeLinejoin="round" />
      <path d="M78 30 L82 6 L58 20 Z" fill="#F79E52" stroke={OUTLINE} strokeWidth={2.8} strokeLinejoin="round" />
      <path d="M25 25 L23 12 L36 20 Z" fill="#4A3524" />
      <path d="M75 25 L77 12 L64 20 Z" fill="#4A3524" />
      <circle cx={50} cy={46} r={28} fill="#FBAF63" stroke={OUTLINE} strokeWidth={3} />
...
export function Munchy({ mouth = "smile", ...props }: ArtProps & { mouth?: MunchyMouth }) {
  return (
    <Art {...props}>
      <path d="M32 20 L26 4" stroke={OUTLINE} strokeWidth={3} strokeLinecap="round" />
      <path d="M68 20 L74 4" stroke={OUTLINE} strokeWidth={3} strokeLinecap="round" />
      <circle cx={26} cy={4} r={5} fill="#FFD84D" stroke={OUTLINE} strokeWidth={2.4} />
      <circle cx={74} cy={4} r={5} fill="#FF8FB1" stroke={OUTLINE} strokeWidth={2.4} />
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M30 36 q6 -12 18 -12" stroke="#9BE7DC" strokeWidth={5} fill="none" strokeLinecap="round" opacity={0.7} />
      ...
      {mouth === "open" ? <ellipse cx={50} cy={74} rx={8} ry={5} fill="#FF7FA6" /> : null}
    </Art>
  );
}

export function Sparkle({ className, fill = "#FFD84D" }: { className?: string; fill?: string }) {
  return (
  ...
  return (
    <svg viewBox="0 0 100 100" className={className} aria-hidden>
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M72 36 q10 14 0 28 M82 26 q18 24 0 48" stroke="#FFFFFF" strokeWidth={5} fill="none" strokeLinecap="round" />
    </svg>
  );
}
