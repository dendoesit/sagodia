...
export const SHAPE_PATHS = {
  ...
  heart: "M50 88 C8 60 10 22 32 18 C43 16 50 25 50 32 C50 25 57 16 68 18 C90 22 92 60 50 88 Z",
} as const;
...
export function ShapeHole({ shape, className }: { shape: ShapeId; className?: string }) {
  return (
    <svg viewBox="0 0 100 100" className={className} aria-hidden>
      <path
        d={SHAPE_PATHS[shape]}
